  ...
  return (
    <section id="projects" className="relative min-h-screen bg-black text-white overflow-hidden px-8 py-24">
      ...
      <div className="absolute inset-0 grid grid-cols-3 grid-rows-2 opacity-10">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="border border-[#B33A3A]/30" />
        ))}
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            ...
            >
              ...
              {/* Corner markers */}
              <div className="absolute top-2 left-2 w-3 h-3 bg-[#FF1E1E]/80 rounded-sm group-hover:scale-125 transition-transform"></div>
              <div className="absolute bottom-2 right-2 w-3 h-3 bg-[#FF1E1E]/80 rounded-sm group-hover:scale-125 transition-transform"></div>
              ...
              <div className="absolute inset-0 flex flex-col p-6 justify-between opacity-0 group-hover:opacity-100 transition-all duration-500 bg-black/40 backdrop-blur-md">
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-sm text-[#FF1E1E] font-spaceGrotesk">{project.subtitle}</p>
                  </div>
                  <motion.h1
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 0.1 }}
                    className="text-8xl font-orbitron text-[#FF1E1E]/50 select-none leading-none"
                  >
                    {project.id}
                  </motion.h1>
                </div>
                ...
                <motion.button
                  ...
                  className="self-start mt-4 px-5 py-2 border border-[#C1440E] text-[#FF1E1E] font-spaceGrotesk rounded-md hover:bg-[#C1440E]/10 transition-all tracking-wide"
                >
                  View Mission
                </motion.button>
              </div>
        ...
        {selected && (
          ...
          >
            <motion.div
              ...
              className="relative w-[90%] max-w-5xl bg-gradient-to-b from-black/80 to-[#B33A3A]/20 border border-[#C1440E]/30 rounded-2xl overflow-hidden shadow-[0_0_60px_rgba(255,0,0,0.1)]"
            >
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-8 p-10 items-center">
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 text-sm text-[#FF1E1E] font-spaceGrotesk tracking-widest">
                ...
                >
                  <h3 className="text-4xl font-orbitron text-[#FF1E1E] tracking-wider drop-shadow-[0_0_8px_rgba(255,0,0,0.5)]">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-6 text-sm font-spaceGrotesk text-gray-400">
                    <div className="border-l-2 border-[#C1440E]/40 pl-3">
                      <p>STATUS</p>
                      <p className="text-[#FF1E1E]">ONLINE</p>
                    </div>
                    <div className="border-l-2 border-[#C1440E]/40 pl-3">
                      <p>SECTOR</p>
                      <p className="text-[#FF1E1E]">ALPHA-03</p>
                    </div>
                    <div className="border-l-2 border-[#C1440E]/40 pl-3">
                      <p>LAST SIGNAL</p>
                      <p className="text-[#FF1E1E]">MJD 60315.2</p>
                    </div>
                    <div className="border-l-2 border-[#C1440E]/40 pl-3">
                      <p>VISUAL TYPE</p>
                      <p className="text-[#FF1E1E]">CINEMATIC</p>
                    </div>
                  </div>

                  <motion.button
                    whileHover={{ scale: 1.1 }}
                    className="mt-8 px-6 py-3 border border-[#C1440E] text-[#FF1E1E] rounded-lg hover:bg-[#C1440E]/10 transition-all tracking-wide"
                  >
